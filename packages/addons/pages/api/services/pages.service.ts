...
export class PagesService {
  constructor(
    @Inject('ENTITY_SERVICE_pages') private readonly entityService: EntityService,
  ) {}
  ...
  create(input: CreatePageDto, actorId: string) {
    return this.entityService.create(input, actorId);
  }

  update(id: string, input: UpdatePageDto, actorId: string, accessCtx?: DataAccessContext) {
