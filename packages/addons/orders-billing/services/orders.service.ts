...
import type { CreateOrderDto, UpdateOrderDto } from '../dto/orders.dto';

@Injectable()
export class OrdersService {
  constructor(@Inject('ENTITY_SERVICE_orders') private readonly entityService: EntityService) {}
  ...
  create(i: CreateOrderDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateOrderDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
