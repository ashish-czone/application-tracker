...
import type { CreateMenuDto, UpdateMenuDto } from '../dto/menus.dto';

@Injectable()
export class MenusService {
  constructor(
    @Inject('ENTITY_SERVICE_menus') private readonly entityService: EntityService,
  ) {}
  ...
  create(input: CreateMenuDto, actorId: string) {
    return this.entityService.create(input, actorId);
  }

  update(id: string, input: UpdateMenuDto, actorId: string, accessCtx?: DataAccessContext) {
