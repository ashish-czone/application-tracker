...
import type { CreateTeamMemberDto, UpdateTeamMemberDto } from '../dto/team-members.dto';

@Injectable()
export class TeamMembersService {
  constructor(@Inject('ENTITY_SERVICE_team-members') private readonly entityService: EntityService) {}
  ...
  create(i: CreateTeamMemberDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateTeamMemberDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
