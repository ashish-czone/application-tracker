...
import type { CreateClientLogoDto, UpdateClientLogoDto } from '../dto/client-logos.dto';

@Injectable()
export class ClientLogosService {
  constructor(@Inject('ENTITY_SERVICE_client-logos') private readonly entityService: EntityService) {}
  ...
  create(i: CreateClientLogoDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateClientLogoDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
