...
import type { CreateValuePropDto, UpdateValuePropDto } from '../dto/value-props.dto';

@Injectable()
export class ValuePropsService {
  constructor(@Inject('ENTITY_SERVICE_value-props') private readonly entityService: EntityService) {}
  ...
  create(i: CreateValuePropDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateValuePropDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
