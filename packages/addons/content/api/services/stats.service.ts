...
import type { CreateStatDto, UpdateStatDto } from '../dto/stats.dto';

@Injectable()
export class StatsService {
  constructor(@Inject('ENTITY_SERVICE_stats') private readonly entityService: EntityService) {}
  ...
  create(i: CreateStatDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateStatDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
