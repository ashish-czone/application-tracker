...
import type { CreateSubscriptionPlanDto, UpdateSubscriptionPlanDto } from '../dto/subscription-plans.dto';

@Injectable()
export class SubscriptionPlansService {
  constructor(@Inject('ENTITY_SERVICE_subscription-plans') private readonly entityService: EntityService) {}
  ...
  create(i: CreateSubscriptionPlanDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateSubscriptionPlanDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
