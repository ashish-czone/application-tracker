...
import type { CreateSubscriptionDto, UpdateSubscriptionDto } from '../dto/subscriptions.dto';

@Injectable()
export class SubscriptionsService {
  constructor(@Inject('ENTITY_SERVICE_subscriptions') private readonly entityService: EntityService) {}
  ...
  create(i: CreateSubscriptionDto, a: string) { return this.entityService.create(i, a); }
  update(id: string, i: UpdateSubscriptionDto, a: string, c?: DataAccessContext) { return this.entityService.update(id, i, a, c); }
