...
// domains can spread them into an extended `pgTable('clients', { ... })`
...
export const clients = pgTable(
  ...
  baseClientColumns,
  (table) => [
    index('clients_name_lower_idx').on(sql`lower(${table.name})`),
    index('clients_merged_into_idx').on(table.mergedIntoId),
