...
/**
 * Resets the compliance API's database to a known minimal state:
 ...
 * tests mutually interfere (rare — typically those that mutate
 * seeded role permissions or workflow definitions), call it from
 * `test.beforeEach` instead.
 *
