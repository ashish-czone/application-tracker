...
--> statement-breakpoint
ALTER TABLE "drafts" ADD CONSTRAINT "drafts_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "drafts_user_entity_key_idx" ON "drafts" USING btree ("created_by_id","entity_type","draft_key");
--> statement-breakpoint
CREATE INDEX "drafts_entity_type_idx" ON "drafts" USING btree ("entity_type");
--> statement-breakpoint
CREATE INDEX "drafts_created_by_id_idx" ON "drafts" USING btree ("created_by_id");
--> statement-breakpoint
