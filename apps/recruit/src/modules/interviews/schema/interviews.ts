...
export const interviews = pgTable('interviews', {
  ...
  interviewFrom: timestamp('interview_from', { withTimezone: true, mode: 'date' }).notNull(),
  interviewTo: timestamp('interview_to', { withTimezone: true, mode: 'date' }).notNull(),
  ...
  index('interviews_client_id_idx').on(table.clientId),
