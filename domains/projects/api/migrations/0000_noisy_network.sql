...
ALTER TABLE "project_tasks" ADD CONSTRAINT "project_tasks_feature_id_features_id_fk" FOREIGN KEY ("feature_id") REFERENCES "public"."features"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "project_tasks_feature_id_idx" ON "project_tasks" USING btree ("feature_id");--> statement-breakpoint
CREATE INDEX "project_tasks_assignee_id_idx" ON "project_tasks" USING btree ("assignee_id");--> statement-breakpoint
...
CREATE INDEX "project_tasks_feature_sort_idx" ON "project_tasks" USING btree ("feature_id","sort_order");