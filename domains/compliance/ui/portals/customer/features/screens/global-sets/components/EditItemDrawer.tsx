...
export interface EditItemDrawerItem {
  id: string;
  name: string;
  slug: string;
  ...
  return (
    <DrawerShell onClose={onClose} width="lg">
      <form onSubmit={handleSubmit} className="flex flex-col h-full">
        <DrawerHeader
          eyebrow={<Eyebrow tone="muted" mark="§">Edit item</Eyebrow>}
          title={item.name}
          subtitle="Update name, slug, or key/value metadata."
          onClose={onClose}
          titleSize="sm"
        />
