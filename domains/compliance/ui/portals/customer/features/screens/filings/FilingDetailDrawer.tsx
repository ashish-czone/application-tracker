  ...
  return (
    <div>
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 group -ml-1.5 pl-1.5 pr-1 py-0.5 border-b border-dashed border-rule/60 hover:border-rule hover:bg-paper-sunken transition-colors"
      >
        {renderValue(value)}
