...
export const seedDemoNotifications = async (ctx: INestApplicationContext): Promise<void> => {
  ...
  const rows = [
    ...
    },
    {
      ...
      isRead: false,
      eventName: 'compliance-tasks.assigned',
      entityType: 'compliance-tasks',
      entityId: null,
    ...
    },
    {
      ...
      isRead: true,
      eventName: 'compliance-tasks.reassigned',
      entityType: 'compliance-tasks',
      entityId: null,
    ...
    },
    {
      ...
      isRead: true,
      eventName: 'compliance-tasks.escalated',
      entityType: 'compliance-tasks',
      entityId: null,
    ...
    },
    {
      ...
      isRead: true,
      eventName: 'compliance-tasks.bulk-reassigned',
      entityType: 'compliance-tasks',
      entityId: null,
