...
export class InterviewsService {
  constructor(
    @Inject('ENTITY_SERVICE_interviews') private readonly entityService: EntityService,
  ) {}
  ...
  create(input: CreateInterviewDto, actorId: string) {
    return this.entityService.create(input, actorId);
  }

  update(id: string, input: UpdateInterviewDto, actorId: string, accessCtx?: DataAccessContext) {
