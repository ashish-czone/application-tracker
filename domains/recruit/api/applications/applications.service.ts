...
import type { CreateApplicationDto, UpdateApplicationDto } from './applications.dto';

@Injectable()
export class ApplicationsService {
  constructor(
    @Inject('ENTITY_SERVICE_applications') private readonly entityService: EntityService,
  ) {}
  ...
  create(input: CreateApplicationDto, actorId: string) {
    return this.entityService.create(input, actorId);
  }

  update(id: string, input: UpdateApplicationDto, actorId: string, accessCtx?: DataAccessContext) {
