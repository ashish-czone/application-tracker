...
7. **Race conditions** - Make sure that there are no concurrency issues in the code like select/update pattern without safeguards
8. **Logic implementation**- verify that the code was written as per the requirements
